...
<html lang="en">
	<!--begin::Head-->
	<head><base href=""/>
		<title>TEBARKEBAIKAN - KEL3</title>
		<meta charset="utf-8" />
		...
		<link rel="shortcut icon" href="{{ asset ('assets/admin/media/logos/logo.png')}}" />
					...
					<div class="app-container container-xxl d-flex align-items-center justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
							<a href="../../demo29/dist/index.html">
								<img alt="Logo" src="assets/admin/media/logos/logo.png" class="h-30px" />
							</a>
						</div>
						<!--end::Logo-->
					...
					<div id="kt_app_sidebar" class="app-sidebar" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-primary">
							...
							<div class="app-sidebar-logo d-none d-md-flex flex-center pt-10 mb-5 mb-lg-17" id="kt_app_sidebar_logo">
								<!--begin::Logo image-->
								<a href="../../demo29/dist/index.html">
									<img alt="Logo" src="assets/admin/media/logos/logo.png" class="h-25px" />
								</a>
								<!--end::Logo image-->
							</div>
							<!--end::Logo-->
										...
										<div class="menu-sub menu-sub-dropdown px-2 py-4 w-250px mh-75 overflow-auto">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="../../demo29/dist/dashboards/ecommerce.html">
													...
													<span class="menu-title">Tranksaksi</span>
												</a>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="/artikel">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
										...
										<div class="menu-sub menu-sub-dropdown px-2 py-4 w-200px w-lg-225px mh-75 overflow-auto">
											...
											<div class="menu-item">
                                                ...
                                                <a class="menu-link" href="#">
													...
													<span class="menu-title">Setting Password</span>
												</a>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
							...
							<div class="d-flex flex-column flex-center pb-4 pb-lg-8" id="kt_app_sidebar_footer">
								...
								<div class="cursor-pointer symbol symbol-40px symbol-circle" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-attach="parent" data-kt-menu-placement="right-end">
									<img src="assets/admin/media/avatars/300-7.jpg" alt="user" />
								</div>
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="symbol symbol-50px me-5">
												<img alt="Logo" src="assets/admin/media/avatars/300-7.jpg" />
											</div>
											<!--end::Avatar-->
											<!--begin::Username-->
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5">Tsalas Raja S</div>
						...
						<div class="app-sidebar-secondary">
							...
							<div class="d-flex flex-column">
								...
								<div class="d-flex flex-column pt-10 ps-11" id="kt_app_sidebar_secondary_header">
									<span class="fs-2 fw-bolder text-white">TEBAR KEBAIKAN</span>
								</div>
									...
									<div class="card">
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
                                                    ...
                                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Pilih Kategori" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                                                ...
                                                                <option value="Analyst">Kesehatan</option>
                                                            </select>
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Actions-->
                                                ...
                                                <!--begin::Action-->
                                                    <a class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">
													...
													<!--end::Svg Icon-->Tambah Artikel</button>
                                                     </a>
                                                <!--end::Action-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_new_card_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="file" class="form-control form-control-solid" placeholder="Masukkan Gambar Disini" name="gambar" value="" />
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        <!--begin::Label-->
                        <label class="fs-6 fw-semibold form-label mb-2">Judul</label>
                        <!--end::Label-->
                        <!--begin::Input wrapper-->
                        <div class="position-relative">
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" placeholder="Masukkan Judul disini..." name="keterangan" value="">
                            <!--end::Input-->
                        </div>
                        <!--end::Input wrapper-->
                    </div>
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <div class="position-relative">
                            <!--begin::Input-->
                            <textarea class="form-control form-control-solid" placeholder="Masukkan Keterangan disini..." name="keterangan" value=""></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input wrapper-->
                    </div>
