        ...
        <div class="row gy-4 mt-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Donasi</P>
              <h4 class="title"><a href="/donasi" class="stretched-link">Pendidikan</a></h4>
            </div>
          </div>
          <!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Donasi</P>
              <h4 class="title"><a href="/donasi" class="stretched-link">Bencana ALam</a></h4>
            </div>
          </div>
          <!--End Icon Box -->
              ...
              <div class="testimonial-wrap">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="/detaildonasi" class="btn btn-primary">Selanjutnya</a>
                    </div>
                  </div>
              </div>
    ...
    <section id="" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          ...
          <p>Marilah kita sesama saudara saling mendoakan yang terbaik</p>
        </div>
        ...
        <div class="row gx-lg-0 gy-4">
          ...
          <div class="col-lg-8">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="submit">Kirim Doa</button></div>
            </form>
